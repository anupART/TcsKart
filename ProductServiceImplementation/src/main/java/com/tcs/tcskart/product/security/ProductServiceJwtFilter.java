...
@Component
public class ProductServiceJwtFilter extends JwtAuthenticationFilter {

    private final TokenBlacklistService tokenBlacklistService;

    public ProductServiceJwtFilter(JwtUtil jwtUtil, TokenBlacklistService tokenBlacklistService) {
        super(jwtUtil);
